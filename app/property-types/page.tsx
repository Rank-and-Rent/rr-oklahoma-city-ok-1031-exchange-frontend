  ...
  return (
    <div>
      ...
      <section className="relative h-[60vh] min-h-[500px] overflow-hidden">
        <Image
          src="/locations/midwest-city-ok-1031-exchange.jpg"
          alt="Investment property types"
          fill
        ...
        <div className="relative z-10 flex h-full flex-col items-center justify-center px-6 text-center text-white">
          ...
          <p className="mt-4 max-w-2xl text-lg text-white/90">
            Explore property types that qualify for 1031 exchange treatment. Find the right replacement property for your investment strategy.
          </p>
