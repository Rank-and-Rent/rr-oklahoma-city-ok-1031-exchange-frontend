...
export const metadata: Metadata = {
  title: "Blog | 1031 Exchange Resources",
...
// Sample featured articles (replace with CMS data)
const featuredArticles = [
  {
    ...
    category: "Exchange Rules",
    date: "January 2024",
    image: "/locations/oklahoma-city-ok-1031-exchange.jpg",
    href: "/blog/45-day-identification-period",
  },
  {
    title: "Oklahoma Real Estate Market Outlook 2025",
    description: "Current trends and opportunities for replacement property investors in the Oklahoma market.",
    category: "Market Analysis",
    date: "December 2024",
    image: "/locations/tulsa-ok-1031-exchange.jpg",
    href: "/blog/oklahoma-market-outlook-2025",
  },
  {
    title: "NNN Properties: The Ideal 1031 Replacement",
    description: "Why triple net lease properties are popular among 1031 exchange investors.",
    category: "Property Types",
    date: "November 2024",
    image: "/locations/edmond-ok-1031-exchange.jpg",
    href: "/blog/nnn-properties-1031-exchange",
  },
];
...
export default async function BlogPage({ searchParams }: Props) {
  ...
  return (
    <div>
      ...
      {/* Featured Articles - Dark Section */}
      <section className="section-dark py-20 md:py-28">
        <div className="mx-auto max-w-7xl px-6 md:px-8">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-center text-gray-400">
            Essential reading for 1031 exchange investors.
          </p>
          ...
          <div className="mt-12 grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            {featuredArticles.map((article) => (
              ...
              >
                ...
                <div className="mt-4">
                  <h3 className="font-heading text-xl uppercase">{article.title}</h3>
                  <p className="mt-2 text-sm text-gray-400 line-clamp-2">{article.description}</p>
                  <p className="mt-3 text-xs uppercase tracking-wider text-gray-500">{article.date}</p>
                </div>
              </Link>
            ))}
          </div>
        ...
        <div className="mx-auto max-w-7xl px-6 md:px-8">
          ...
          {posts.length === 0 && (
            <div className="mt-8 rounded-lg border border-gray-200 bg-gray-50 p-12 text-center">
              <h3 className="font-heading text-2xl uppercase">Coming Soon</h3>
              <p className="mt-4 text-gray-600">
                We&apos;re working on creating valuable content for 1031 exchange investors. 
                Check back soon for articles, guides, and market insights.
              </p>
      ...
      <section className="bg-gray-50 py-16 md:py-20">
        <div className="mx-auto max-w-7xl px-6 md:px-8">
          ...
          <p className="mt-4 text-gray-600">
            Official guidance and resources for 1031 exchange investors.
          </p>
          ...
          <div className="mt-8 space-y-4">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="group flex items-center justify-between rounded-lg border border-gray-200 bg-white p-6 transition hover:border-gray-400"
            >
              <div>
                <h3 className="font-heading text-lg uppercase">IRS Publication 544</h3>
                <p className="mt-1 text-sm text-gray-600">Sales and Other Dispositions of Assets</p>
              </div>
            ...
            >
              <div>
                <h3 className="font-heading text-lg uppercase">IRS Form 8824</h3>
                <p className="mt-1 text-sm text-gray-600">Like-Kind Exchanges (and section 1043 conflict-of-interest sales)</p>
              </div>
              <svg className="h-5 w-5 text-gray-400 transition-transform group-hover:translate-x-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" />
              </svg>
            ...
            >
              <div>
                <h3 className="font-heading text-lg uppercase">IRC Section 1031</h3>
                <p className="mt-1 text-sm text-gray-600">Exchange of real property held for productive use or investment</p>
              </div>
              <svg className="h-5 w-5 text-gray-400 transition-transform group-hover:translate-x-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" />
              </svg>
