...
export const metadata: Metadata = {
  title: "Oklahoma Neighborhoods | 1031 Exchange Service Areas",
  description: "Discover Oklahoma's best neighborhoods for 1031 exchange investments. Browse our area guides to learn about each market.",
  alternates: {
...
export default function LocationsPage() {
  return (
    <div>
      ...
      <section className="relative h-[60vh] min-h-[500px] overflow-hidden">
        ...
        <div className="relative z-10 flex h-full flex-col items-center justify-center px-6 text-center text-white">
          <h1 className="font-heading text-5xl uppercase tracking-wide md:text-6xl lg:text-7xl">
            Oklahoma Neighborhoods
          </h1>
          <p className="mt-4 max-w-2xl text-lg text-white/90">
            Discover more about Oklahoma real estate! Browse our neighborhood guides to learn about the best areas for you.
          </p>
      ...
      {/* Neighborhoods Grid - Dark Section */}
